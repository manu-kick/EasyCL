...
def gap_embedding_dim_pairs(cf, text_embeddings, audio_embeddings, vision_embeddings, iterations, labels):
    ...
    modalities_embeddings['audio'] = torch.Tensor(audio_embeddings)
    ...
    modality_pairs = [("text", "audio"), ("text", "vision"), ("audio", "vision")]
    diffs = dict()
    ...
    for idx, (mod1, mod2) in enumerate(modality_pairs):   
        ...
        # Plot the 2D scatter plot for the pair of modalities in subplot
        ax = axes[idx]
